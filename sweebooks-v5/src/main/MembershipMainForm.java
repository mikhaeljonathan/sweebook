...
//    		borrowForm.setBounds(174, 11, 500, 261);
		...
		btnNewButton.setBounds(10, 11, 140, 35);
		...
		btnBookView.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				ViewBookForm bookForm = new ViewBookForm();
				bookForm.setResizable(false);
				bookForm.setLocation(174, 11);
				getContentPane().add(bookForm);
				bookForm.getContentPane().setLayout(null);
